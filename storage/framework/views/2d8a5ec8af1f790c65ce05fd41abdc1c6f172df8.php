...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('old.index')); ?>" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="<?php echo e(route('old.store')); ?>" id="dataForm">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="form-group col-md-6 " >                  
                            ...
                            <input type="text" class="form-control number" name="price_new" id="price_new" value="<?php echo e(old('price_new')); ?>">
                        </div>
            ...
            <div class="box-footer">              
              ...
              <a class="btn btn-default" class="btn btn-primary" href="<?php echo e(route('old.index')); ?>">Hủy</a>
            </div>
