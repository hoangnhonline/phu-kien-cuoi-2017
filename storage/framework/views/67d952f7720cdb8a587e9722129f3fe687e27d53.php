            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="white-space:nowrap; text-align:right">
                 ...
                 <a class="btn btn-default btn-sm" href="<?php echo e(route('child-cate', [$loaiSp->slug, $item->slug] )); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
                  <?php if($item->home_style > 0): ?>
                  <a class="btn-sm btn btn-primary" href="<?php echo e(route('banner.index', ['object_type' => 2, 'object_id' => $item->id])); ?>" ><span class="badge"><?php echo e($item->banners->count()); ?></span> Banner </a>
                  <?php endif; ?>
