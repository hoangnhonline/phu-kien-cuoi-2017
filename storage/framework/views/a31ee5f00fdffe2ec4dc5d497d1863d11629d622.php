...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="<?php echo e(route('articles.store')); ?>" id="dataForm">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image_url" src="<?php echo e(old('image_url') ? Helper::showImage(old('image_url')) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="85">                    
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" class="editor" name="content" id="content"><?php echo e(old('content')); ?></textarea>
                </div>
