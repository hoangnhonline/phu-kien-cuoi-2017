...
<div class="wrapper">
  ...
  <?php if(Auth::user()->email != "huongll@DASHBOARD" && \Request::route()->getName() != "compare.index" ): ?>
...
<input type="hidden" id="upload_url" value="<?php echo e(config('phukien.upload_url')); ?>">
