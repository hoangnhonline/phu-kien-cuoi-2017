							...
							<div class="tr-wrap">
								<div class="table-row clearfix">
									...
									<div class="table-cell product-col">
										...
										<a href="javascript:void(0)" onclick="return confirm('Quý khách chắc chắn muốn xóa sản phẩm này?'); " title="Xóa" data-id="<?php echo e($product->id); ?>" class="del_item">Xóa</a>
