...
<div class="wrapper">
  ...
  <?php if(Auth::user()->email != "huongll@annammobile.com" && \Request::route()->getName() != "compare.index" ): ?>
...
<?php echo $__env->make('backend.customer.customer-notification-modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- /.content-wrapper -->
...
<input type="hidden" id="upload_url" value="<?php echo e(config('annam.upload_url')); ?>">
<!-- ./wrapper -->
