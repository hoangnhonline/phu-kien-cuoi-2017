...
<div class="block_news row">
    <div class="col-md-9 col-sm-9 col-xs-12 block_cate_left">
        <div class="block_news_content">
            ...
            <form method="GET" action="<?php echo e(route('bao-hanh')); ?>">
                <div id="warranty_service">
                <div id="searchcontainer">                    
                    <input placeholder="Nhập mã IMEI hoặc serial number của sản phẩm tại đây" class="warranty_input_search_serial" id="input_imei" name="serial_no" value="<?php echo e($serial_no); ?>">
                ...
                <div id="infowarranty">
                    <?php if($kq == 1): ?>
                    <p style="color:#0084CB">Sản phẩm còn bảo hành đến : <strong style="font-size:17px"><?php echo e(date('d/m/Y', strtotime($end_date))); ?></strong> </p>
                    <?php elseif($kq == 2): ?>
