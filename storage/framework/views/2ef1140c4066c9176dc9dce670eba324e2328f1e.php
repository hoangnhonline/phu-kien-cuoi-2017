...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default" href="<?php echo e(route('cate-parent.index')); ?>" style="margin-bottom:5px">Quay lại</a>
          ...
          <form role="form" method="POST" action="<?php echo e(route('cate-parent.update')); ?>">
            ...
            <div class="box-body">
              ...
              <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="<?php echo e(old('image_url', $detail->image_url) ? Helper::showImage( old('image_url', $detail->image_url) ) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="85">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="<?php echo e(route('cate-parent.index')); ?>">Hủy</a>
            </div>
