          ...
          <li class="col-sm-5ths col-xs-6 product_item">
            <div class="de_old_img">
              <a href="<?php echo e(route('product-detail', [$product->slug, $product->id])); ?>" title="<?php echo $product->name; ?>">
                <img width="150" height="150" alt="<?php echo $product->name; ?>" src="<?php echo e($product->image_url ? Helper::showImageThumb($product->image_url) : URL::asset('admin/dist/img/no-image.jpg')); ?>">
              </a>
