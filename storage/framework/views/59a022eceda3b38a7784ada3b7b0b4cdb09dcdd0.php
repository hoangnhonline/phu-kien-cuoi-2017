				...
				<div class="block_customer-frm col-md-8">
					<div class="block_buy-frm">
						...
						<div class="filter-group">
							...
							<div class="row-group">
                                <input type="email" name="email" id="email" value="<?php echo old('email'); ?>" placeholder="Email (cần nhập email để nhận được thông tin đơn hàng từ An Nam)" class="email ip_precheck">
                            </div><!-- /row-group -->
                            <div class="row-group clearfix">
