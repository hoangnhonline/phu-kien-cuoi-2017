...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('banner.create', ['object_id' => $arrSearch['object_id'], 'object_type' => $arrSearch['object_type']])); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px;<?php echo e($arrSearch['object_type'] == 3 && in_array($arrSearch['object_id'], [2,3]) && $items->count() == 1 ? 'display:none' : ''); ?>" 

      >Tạo mới</a>
      <?php if($arrSearch['object_type'] == 3): ?>
      <a class="btn btn-default btn-sm" href="<?php echo e(route('banner.list')); ?>" style="margin-bottom:5px;">Quay lại</a>
      <?php endif; ?>
      <div class="box">
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td>                  
                  <img class="img-thumbnail banner" width="380" src="<?php echo e($item->image_url ? Helper::showImage($item->image_url) : URL::asset('public/admin/dist/img/no-image.jpg')); ?>" />
                </td>                                                             
