...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('old.index', ['loai_id' => $detail->loai_id, 'cate_id' => $detail->cate_id])); ?>" style="margin-bottom:5px">Quay lại</a>
    ...
    <form role="form" method="POST" action="<?php echo e(route('old.update')); ?>" id="dataForm">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="form-group col-md-6" >                  
                            ...
                            <input type="text" class="form-control number <?php echo e(old('is_old', $detail->is_old) == 1  ? "req" : ""); ?>" name="price_new" id="price_new" value="<?php echo e(old('price_new', $detail->price_new)); ?>">
                        </div>
                         <div class="col-md-6 none-padding">
                          <label>Số lượng tồn<span class="red-star">*</span></label>                  
                          <input type="text" class="form-control req number" name="so_luong_ton" id="so_luong_ton" value="<?php echo e(old('so_luong_ton', $detail->so_luong_ton)); ?>">                        
                        </div>
                      <div class="col-md-6">
                          <label>Màu sắc</label>
                      ...
                      <div class="form-group col-md-6 none-padding pleft-5">
                        ...
                        <textarea class="form-control" rows="4" name="khuyen_mai" id="khuyen_mai"><?php echo e(old('khuyen_mai', $detail->khuyen_mai)); ?></textarea>
                      </div>
                      ...
                      <?php foreach($thuocTinhArr as $loaithuoctinh): ?>
                        ...
                        <?php if( !empty($loaithuoctinh['child'])): ?>
                          ...
                          <tr>
                            ...
                            <td><input type="text" class="form-control" name="thuoc_tinh[<?php echo e($thuoctinh['id']); ?>]" value="<?php echo e(isset($spThuocTinhArr[$thuoctinh['id']]) ?  $spThuocTinhArr[$thuoctinh['id']] : ""); ?>" ></td>
                          </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
                      <?php endforeach; ?>
            ...
            <div class="box-footer">             
              ...
              <a class="btn btn-default" class="btn btn-primary" href="<?php echo e(route('old.index', ['loai_id' => $detail->loai_id, 'cate_id' => $detail->cate_id])); ?>">Hủy</a>
            </div>
  ...
  if(e.which == 13) {
    ...
    $(document).ready(function(){
      ...
      $('#loai_id').change(function(){
        location.href="<?php echo e(route('old.create')); ?>?loai_id=" + $(this).val();
      })
      $(".select2").select2();
