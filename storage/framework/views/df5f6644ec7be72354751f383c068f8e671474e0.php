                  ...
                  <tbody>
                    <tr>
                      ...
                      <h1 style="font-size:17px;font-weight:bold;color:#444;padding:0 0 5px 0;margin:0"> Cảm ơn
                          quý khách <?php echo e($orderDetail->full_name); ?>

                          đã đặt hàng tại annammobile.com,</h1>                    
                        <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"> annammobile.com rất vui thông báo đơn hàng #<?php echo e($order_id); ?> của quý khách đã
                    ...
                    <tr>
                      <td style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px"><table cellspacing="0" cellpadding="0" border="0" width="100%">
                          ...
                          <tbody>
                           ...
                           <tr>
                              <td valign="top" style="padding:3px 9px 9px 9px;border-top:0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"><span style="text-transform:capitalize"><?php echo $orderDetail->full_name; ?></span><br>
                                <a href="mailto:<?php echo $orderDetail->email; ?>" target="_blank"><?php echo $orderDetail->email; ?></a><br>
                                <?php echo $orderDetail->phone; ?> </td>
                              <td valign="top" style="padding:3px 9px 9px 9px;border-top:0;border-left:0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"><span style="text-transform:capitalize"><?php echo $orderDetail->full_name; ?></span><br>
                                <a href="mailto:<?php echo $orderDetail->email; ?>" target="_blank"><?php echo $orderDetail->email; ?></a><br>                                
                                  <?php echo $orderDetail->city->name; ?>,                                
                                  <?php echo $orderDetail->district->name; ?>,                                
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#f5f5f5">
                          ...
                          <tfoot style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px">
                            ...
                            <tr bgcolor="#eee">
                              ...
                              <td align="right" style="padding:7px 9px"><strong><big><span><?php echo number_format($orderDetail->tong_tien); ?>&nbsp;₫</span></big></strong></td>
                            </tr>
                          </tfoot>
                        </table>                        
                    </tr>                    
