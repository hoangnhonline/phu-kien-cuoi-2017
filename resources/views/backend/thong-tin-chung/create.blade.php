...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('thong-tin-chung.index') }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('thong-tin-chung.store') }}" id="dataForm">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="10" name="detail" id="detail">{{ old('detail') }}</textarea>
                        </div>
            ...
            <div class="box-footer">              
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('thong-tin-chung.index')}}">Hủy</a>
            </div>
