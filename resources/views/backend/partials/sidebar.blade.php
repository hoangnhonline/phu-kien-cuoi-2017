<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview {{ in_array(\Request::route()->getName(), ['product.index', 'product.create', 'product.edit', 'cate-parent.index', 'cate-parent.edit', 'cate-parent.create', 'cate.index', 'cate.edit', 'cate.create', 'product.kho']) ? 'active' : '' }}">
        <a href="#">
