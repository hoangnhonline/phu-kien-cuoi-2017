			...
			<div class="footer_top">
				<div class="container">
					<ul class="row block_bottom_menu">
	                    ...
	                    <li><a href="{{ route('cate-parent', 'chinh-sach-bao-hanh') }}" title="Chính sách bảo hành">Chính sách bảo hành</a></li>
	                    <li><a href="{{ route('cate-parent', 'gioi-thieu') }}" title="Giới thiệu">Giới thiệu</a></li>
	                    <li><a href="{{ route('contact') }}" title="Liên hệ">Liên hệ</a></li>
	                    <li><a href="{{ route('cate-parent', 'huong-dan-dat-hang') }}" title="Hướng dẫn đặt hàng">Hướng dẫn đặt hàng</a></li>	            
	                    <li><a href="{{ route('cate-parent', 'chinh-sach-bao-mat') }}" title="Chính sách bảo mật">Chính sách bảo mật</a></li>
