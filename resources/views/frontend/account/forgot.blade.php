  ...
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal;text-align:left;padding-left:20px">
        ...
        <p><span style="font-weight:bold">annammobile.com</span> đã nhận được yêu cầu thay đổi mật khẩu của quý khách.</p>
        ...
        <p>Mọi thắc mắc và góp ý vui lòng liên hệ với chúng tôi qua email: <span style="color:red; font-weight:bold">support@annammobile.com</span> hoặc số điện thoại <span style="color:red; font-weight:bold">1900 636 975</span> (8-21h cả T7,CN).</p>
        <p>Trân trọng,<br> <span style="font-weight:bold">annammobile.com</span></p>
