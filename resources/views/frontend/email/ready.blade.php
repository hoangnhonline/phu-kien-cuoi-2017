                  ...
                  <tbody>
                    <tr>
                      <td><h1 style="font-size:17px;font-weight:bold;color:#444;padding:0 0 5px 0;margin:0"> Cảm ơn
                        ...
                        <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"> annammobile.com rất vui thông báo đơn hàng #{{$order->id}} của quý khách đã
